...
config.SYSTEM.TEAM_NAME = 'coatnet_tttt' # text.replace(" ","")
...
config.TRAIN.MODEL = 'coatnet_tttt'
...
block_types = ['T', 'T', 'T', 'T']
model = CoAtNet((224, 224), 3, num_blocks, channels, num_classes=num_classes, block_types=block_types)
