...
config.SYSTEM.TEAM_NAME = 'efficientnet_b7' # text.replace(" ","")
...
config.TRAIN.MODEL = 'efficientnet_b2'

# 사용할 augmentation
config.TRAIN.AUGMENTATION = {'size': 288, 'use_flip': True, 'use_color_jitter': True,
                             'use_gray_scale': True, 'use_normalize': True}  
config.TEST.AUGMENTATION = {'size': 288, 'use_normalize': True}
