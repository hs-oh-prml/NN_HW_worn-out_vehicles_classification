...
config.SYSTEM.TEAM_NAME = 'ViT_SGD' # text.replace(" ","")
...
config.TRAIN.MODEL = 'ViT_SGD'

# 사용할 augmentation
config.TRAIN.AUGMENTATION = {'size': 256, 'use_flip': True, 'use_color_jitter': True,
                             'use_gray_scale': True, 'use_normalize': True}  
config.TEST.AUGMENTATION = {'size': 256, 'use_normalize': True}
...
num_classes=5
model = ViT(image_size=256, patch_size=32, 
            num_classes=num_classes, depth=6, dim=1024,
